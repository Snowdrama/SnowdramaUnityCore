...
public class SaveGame_LoadAutoSaveButton : MonoBehaviour, ISaveButton
{
    ...
    public void TryLoad()
    {
        if (SaveManager.CanLoadAutoSave(saveSlot))
        {
    ...
    {
        SaveManager.LoadAutoSave(saveSlot);
    }
